...
class Wheel(Base):
    """Alias for WheelStrategy for backwards compatibility"""
    __tablename__ = "wheel_strategies_compat"
    
    id = Column(Integer, primary_key=True, index=True)
    name = Column(String)

class WheelEventImport(Base):
    """Model for tracking wheel event imports"""
